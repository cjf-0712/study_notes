# 集合了图像优化和模拟缺陷以及亮度调整
# 12.23 1.优化多重文件夹生成问题 2.优化参数传递集中在主程序 3.功能函数集成化方便调用
import tempfile
import os
...
#quexian_moni 在整合亮度设置和模拟图像缺陷和缩放功能，整合了个图像处理前置模块
def process_image(image_path, temp_path):
    try:
        ...
        # 保存处理后的图片到输出路径
        img.save(temp_path)
        print(f"我是模拟缺陷，模拟缺陷已保存处理后的图片到 {temp_path}")
...
if __name__ == "__main__":
    ...
    input_directory = r"F:\FPGA\unilumin_work\pic\pic_ku\sip_pic"  # 输入文件夹路径
    output_directory = r"F:\FPGA\unilumin_work\pic\0107\33gs_3"  # 输出文件夹路径
    # 设定每个颜色通道的增益系数
    """
    ...
    """
    #颜色增益通道
    rfactor = 1.2  # 红色通道的增益系数
    gfactor = 1.3  # 绿色通道的增益系数
  ...
  0.00000067]
 [0.00002292 0.00078634 0.00655965 0.01330373 0.00655965 0.00078633
  0.00002292]
 ...
 [0.00019117 0.00655965 0.05472157 0.11098164 0.05472157 0.00655965
  0.00019117]
 [0.00002292 0.00078633 0.00655965 0.01330373 0.00655965 0.00078634
  0.00002292]
 [0.00000067 0.00002292 0.00019117 0.00038771 0.00019117 0.00002292
  0.00000067]
    """
