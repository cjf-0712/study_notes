...
if __name__ == "__main__":
    ...
    input_directory = r"F:\FPGA\unilumin_work\pic\word_200"  # 输入文件夹路径
    output_directory = r"F:\FPGA\unilumin_work\pic\youhua1.1"  # 输出文件夹路径
    output_directory2 = r"F:\FPGA\unilumin_work\pic\youhua1.2"
    # 设定每个颜色通道的增益系数
    """
