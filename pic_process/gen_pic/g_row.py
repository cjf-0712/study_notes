...
def create_custom_image(width, height, save_path):
    ...
    for y in range(height ):
        pixels[middle_column - 2, y] = (255, 255, 255)
    for y in range(height ):
        pixels[middle_column - 1, y] = (255, 255, 255)
    for y in range(height ):
        pixels[middle_column - 1, y] = (255, 255, 255)
    """

    for y in range(height ):
        pixels[middle_column , y] = (255, 255, 255)
    # 确保保存路径的文件夹存在
...
if __name__ == "__main__":
    # 设置图片尺寸
    width = 320  # 您可以根据需要调整宽度
    height = 180  # 您可以根据需要调整高度
    ...
    save_path = r"F:\FPGA\unilumin_work\pic\pic_ku\sip_pic\dansu.png"
