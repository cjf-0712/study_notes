        ...
        for y in range(0, height, 4):
            for x in range(0, width, 4):
                ...
                def average_channel(group, channel):
                    return int(sum([pixel[channel] for pixel in group]) )
...
if __name__ == "__main__":
    input_directory = r"F:\FPGA\unilumin_work\pic\GEN_COLOR\64"
    output_directory = r"F:\FPGA\unilumin_work\pic\sum_TEST1"
