    ...
    try:
        ...
        for y in range(height):
            for x in range(width):
                ...
                # 蓝色覆盖正方形的下半部分
                blue_bbox = [
                    (top_left_x, top_left_y + scale_factor *2 // 3),
                ...
                red_bbox = [
                    ...
                    (top_left_x + scale_factor // 2, top_left_y + scale_factor *2 // 3)
                ]
                ...
                green_bbox = [
                    ...
                    (top_left_x + scale_factor, top_left_y + scale_factor *2 // 3)
                ]
...
if __name__ == "__main__":
    # 用户可以在此处设置参数
    input_folder = r"F:\FPGA\unilumin_work\pic\pic_ku\test_160"  # 输入文件夹路径
    output_folder = r"F:\FPGA\unilumin_work\pic\0107\dis_2.3"  # 输出文件夹路径
    scale_factor = 12                  # 缩放比例因子，用户可自行调整
