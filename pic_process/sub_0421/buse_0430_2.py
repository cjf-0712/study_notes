...
if __name__ == "__main__":
    # 配置输入输出路径
    input_folder = r"F:\FPGA\unilumin_work\pic\pic_ku\kill_0430"  # 替换为你的输入文件夹
    output_folder = r"F:\FPGA\unilumin_work\pic\pic_ku\final\buse_0430"  # 替换为输出文件夹
