...
if __name__ == "__main__":
    ...
    input_directory = r"F:\FPGA\unilumin_work\pic\pic_ku\small_word"  # 输入文件夹路径
    output_directory = r"F:\FPGA\unilumin_work\pic\0114\word_1"  # 输出文件夹路径
    # 设定每个颜色通道的增益系数
    """
    ...
    """
    #颜色增益通道
    rfactor = 1.4  # 红色通道的增益系数
    gfactor = 1  # 绿色通道的增益系数
    bfactor = 1.2  # 蓝色通道的增益系数
    # 卷积矩阵参数
     # 卷积核尺寸
    size = 3
     # 矩阵参数比
